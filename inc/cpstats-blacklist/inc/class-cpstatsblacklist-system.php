<?php
/**
 * CPStats Filter: CPStatsBlacklist_System class
 *
...
/**
 * CPStats Filter system configuration.
 *
 * @since   1.0.0
 */
class CPStatsBlacklist_System extends CPStatsBlacklist {
	...
	public static function uninstall() {
		...
		delete_option( 'cpstats-blacklist' );
	}
